This directory holds the components of the SNmult tool package:

(1) the Springer Nature document class "SNmult.cls"

(2) guideline and instructions for contributing authors and volume editors: "instructions.pdf"
...
- the pdf file "author.pdf" as an example of a "contribution"
...
- the pdf file "editor.pdf" as an example of a "complete book"
