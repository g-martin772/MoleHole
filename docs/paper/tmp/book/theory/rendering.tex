...
%
%%%%%%%%%%%%%%%%%%%%%%%% Springer Nature %%%%%%%%%%%%%%%%%%%%%%%%%%
\motto{All problems in computer graphics can be solved with a matrix 
inversion. ---Jim Blinn}
\chapter{Computer Graphics}
\label{computer-graphics}

\abstract*{
  The following chapter will conclude most important theoretical work 
  on computer graphics and the technology of rendering a picture on 
  a computer screen. For this purpose the rendering equation will play 
  a big role and be followed by the terms of ray tracing and ray marching.
  Moreover, the view projection matrix is vital for understanding the 
  basic visual guidance and interactivity for human and computer.
}
...
\bibliography{theory/ref-rendering}
