...
Dieser Abschnitt bietet einen Überblick des Projektes aus der Sicht des Projektkoordinators.
Es wird auf die Teamarbeit sowie die schulische Betreuung eingegangen. \\

\textbf{Zusammenarbeit im Team} \\

Die Zusammenarbeit im Team verlief bis jetzt ausgesprochen gut.
Beide Mitglieder brachten ihre individuellen Stärken ein und ergänzten sich dadurch ausgezeichnet.
Es wurden viele konzeptionelle Herausforderungen gemeinsam besprochen und gelöst.
...
Die Umsetzung des Projektes erfolgt auf der Basis agiler Methoden mit 3 Wochen Sprints, wie
in~\ref{subsubsec:planning} erläutert.
...
Die Aufgaben werden in einem Kanban-Board in YouTrack~\autocite{Website:YouTrack} verwaltet,
...
wie in~\ref{subsubsec:implementation} beschrieben.
...
Zum Stand des 22.01.2026 betrug der gesamte Zeitaufwand für das Projekt etwa 175 Stunden.
