...
\\}
\author{
	Gabriel Martin\textsuperscript{1}, Leonhard Neuhold\textsuperscript{2} und
...
\begin{document}
	...
	\begin{abstract}
		Dies ist der Projektbericht für das MoleHole Projekt mit der Nummer ? der Kategorie Science,
		welches im Rahmen des Faches Projektmanagement der IT-Abteilung an der HTL Krems –
		Alauntalstraße 29, 3500 Krems – stattfindet.
