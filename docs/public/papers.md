...
This project aims to contribute to science, so there is a paper currently in progress and one documentation report
already finished.
...
to hand in. This file can be downloaded at <a id="raw-url" href="./molehole_ji_documentation.pdf">Project Report</a>.
